...
// Dynamically import the 3D hat component with no SSR and proper suspense
const LuffyHat3D = dynamic(() => import("./LuffyHat3D"), {
  ssr: false,
  loading: () => null, // Don't show loading state to prevent flash
});

// Create a client-only wrapper component for the hat
function ClientHat() {
  return (
    <div className="absolute -top-20 -left-16 md:-top-28 md:-left-20 w-40 h-40 md:w-56 md:h-56 z-10">
