...
export default function Projects() {
  ...
  const otherProjects = [
    ...
    },
    {
      ...
      githubLink:
        "https://github.com/NethmaDS123/Student-Performance-Predictor",
      liveLink:
      ...
      <div className="max-w-4xl mx-auto">
              ...
              <div className="flex gap-6">
                {"githubLinks" in project ? (
                  <>
                    ...
                    >
                      <span className="mr-2 text-sm">Frontend Code</span>
                      <svg
                        className="w-4 h-4"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                    >
                      <span className="mr-2 text-sm">Backend Code</span>
                      <svg
                        className="w-4 h-4"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <span className="mr-2 text-sm">Live Demo</span>
                  <svg
                    className="w-4 h-4"
                    fill="none"
                    stroke="currentColor"
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tech.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className="px-2 py-1 bg-gray-800 text-gray-300 rounded-md text-xs font-medium border border-gray-700 hover:border-emerald-500/50 hover:text-emerald-300 transition-colors"
                    >
                      {tech}
                    </span>
                  ))}
        ...
        <div className="mt-8 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center text-gray-300 hover:text-emerald-400 transition-colors text-sm"
          >
